...
/*    val budget: String = "$150 000 000"*/
    ...
    companion object {
/*        fun getDefaultMovie() = Movie("Some Movie", "1985", 0)

        fun getDefaultMovieList() = listOf(
            MovieCard(Movie("Jurassic Park", "1993", 0), 8, 0),
            MovieCard(Movie("Pulp Fiction", "1994", 0), 9, 0),
            MovieCard(Movie("Goodfellas", "1990", 0), 9, 0),
            MovieCard(Movie("Fight Club", "1999", 0), 9, 0),
            MovieCard(Movie("The Big Lebowski", "1998", 0), 8, 0),
            MovieCard(Movie("Fargo", "1996", 0), 8, 0),
            MovieCard(Movie("Magnolia", "1999", 0), 8, 0),
            MovieCard(Movie("Se7en", "1995", 0), 9, 0),
            MovieCard(Movie("Boogie Nights", "1997", 0), 8, 0),
            MovieCard(Movie("Reservoir Dogs", "1992", 0), 8, 0),
            MovieCard(Movie("The Shawshank Redemption", "1994", 0), 9, 0),
        )*/
    }
}
